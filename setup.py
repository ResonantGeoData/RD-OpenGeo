...
setup(
    ...
    extras_require={
        ...
        'worker': [
            'django-rgd-3d[worker]==0.3.11',
            'django-rgd-fmv[worker]==0.3.11',
            'django-rgd-geometry[worker]==0.3.11',
            'django-rgd-imagery[worker]==0.3.11',
        ],
        'fuse': [
            'django-rgd[fuse]==0.3.11',
        ],
    },
)
