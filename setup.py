...
setup(
    ...
    extras_require={
        ...
        'worker': [
            'django-rgd-3d[worker]==0.3.8',
            'django-rgd-fmv[worker]==0.3.8',
            'django-rgd-geometry[worker]==0.3.8',
            'django-rgd-imagery[worker]==0.3.8',
        ],
        'fuse': [
            'django-rgd[fuse]==0.3.8',
        ],
    },
)
